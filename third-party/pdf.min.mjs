...
class AnnotationEditorUIManager {
    ...
    return shadow(
      ...
      new KeyboardManager([
        ...
        [
          ...
          {
            checker: (t, { target: e }) =>
              !(e instanceof HTMLButtonElement) && t.#pt.contains(e) && !t.isEnterHandled,
          },
        ],
        [
          [' ', 'mac+ '],
          ...
          {
            checker: (t, { target: e }) =>
              !(e instanceof HTMLButtonElement) && t.#pt.contains(document.activeElement),
          },
        ],
  ...
  constructor(t, e, i, s, n, a, r, o, l, h, d, c, u) {
    ...
    s._on('switchannotationeditorparams', (t) => this.updateParams(t.type, t.value), { signal: p });
    this.#ft();
    this.#bt();
    this.#At();
  ...
  get hcmFilter() {
    return shadow(
      this,
      'hcmFilter',
      this.#lt ? this.#W.addHCMFilter(this.#lt.foreground, this.#lt.background) : 'none'
    );
  }
  get direction() {
  ...
  get highlightColors() {
    return shadow(
      this,
      'highlightColors',
      this.#K ? new Map(this.#K.split(',').map((t) => t.split('=').map((t) => t.trim()))) : null
    );
  }
  ...
  #Et(t = '') {
    this.#at === g.HIGHLIGHT ? this.highlightSelection(t) : this.#$ && this.#yt();
  }
  #ft() {
  ...
  #_t(t) {
    if (Object.entries(t).some(([t, e]) => this.#dt[t] !== e)) {
      ...
      this.#at === g.HIGHLIGHT && !1 === t.hasSelectedEditor && this.#Rt([[m.HIGHLIGHT_FREE, !0]]);
    }
  }
  #Rt(t) {
  ...
  showAllEditors(t, e, i = !1) {
    ...
    (this.#ht?.get(m.HIGHLIGHT_SHOW_ALL) ?? !0) !== e && this.#Rt([[m.HIGHLIGHT_SHOW_ALL, e]]);
  }
  enableWaiting(t = !1) {
    if (this.#tt !== t) {
      this.#tt = t;
  ...
  removeEditor(t) {
    ...
    this.#D.delete(t.id);
    this.unselect(t);
    (t.annotationElementId && this.#H.has(t.annotationElementId)) || this.#I?.remove(t.id);
  }
  ...
  #It() {
    ...
    if (1 === this.#D.size) for (const t of this.#D.values()) return t.isEmpty();
    return !1;
  }
  delete() {
    this.commitOrRemove();
  ...
  get isEditorHandlingKeyboard() {
    return (
      ...
      (1 === this.#rt.size && this.firstSelectedEditor.shouldGetKeyboardEvents())
    );
  }
  isActive(t) {
    return this.#P === t;
  ...
  renderAnnotationElement(t) {
    ...
    i && (this.#at !== g.NONE || i.hasBeenModified) && i.renderAnnotationElement(t);
  }
}
class AltText {
  #o = null;
  ...
  async #Kt() {
    ...
    if (this.#Nt) e.setAttribute('data-l10n-id', 'pdfjs-editor-alt-text-decorative-tooltip');
    else {
...
class TouchManager {
  ...
  #oe(t) {
    ...
    const { screenX: s, screenY: n } = e,
      ...
      f = Math.hypot(g, m) || 1,
      b = Math.hypot(u, p) || 1;
    if (!this.#Yt && Math.abs(b - f) <= TouchManager.MIN_TOUCH_DISTANCE_TO_PINCH) return;
    o.touch0X = s;
    o.touch0Y = n;
    o.touch1X = a;
    o.touch1Y = r;
...
class AnnotationEditor {
  ...
  focusin(t) {
    this._focusEventsAllowed && (this.#ve ? (this.#ve = !1) : this.parent.setSelected(this));
  }
  focusout(t) {
  ...
  #Be(t, e) {
    ...
    [y, x] = ((S = y / i), (C = x / s), [c[0] * S + c[2] * C, c[1] * S + c[3] * C]);
    var S, C;
    if (g) {
      const t = Math.hypot(r, o);
      _ = E = Math.max(
        Math.min(Math.hypot(b[0] - f[0] - y, b[1] - f[1] - x) / t, 1 / r, 1 / o),
        l / r,
        h / o
      );
    } else
    ...
    if (e) {
      ...
      window.addEventListener(
        ...
        (t) => {
          ...
          const [a, r] = this.screenToPageTranslation(e - this.#Ce, s - this.#Te);
          this.#Ce = e;
          this.#Te = s;
      ...
      window.addEventListener(
        'pointerdown',
        (t) => {
          t.pointerType === this.#pe && (this.#Pe || t.isPrimary) && cancelDrag(t);
          stopEvent(t);
        },
        a
      );
  ...
  keydown(t) {
    ...
    if (n !== s) {
      if (n < s) for (let t = 0; t < s - n; t++) this.#me.append(this.#me.firstChild);
      else if (n > s)
        for (let t = 0; t < n - s; t++) this.#me.firstChild.before(this.#me.lastChild);
      let t = 0;
      for (const i of e) {
...
class MurmurHash3_64 {
  ...
  hexdigest() {
    ...
    e = ((4283543511 * e) & nt) | (((2950163797 * ((e << 16) | (t >>> 16))) & nt) >>> 16);
    t ^= e >>> 1;
    t = ((444984403 * t) & nt) | ((60499 * t) & at);
    e = ((3301882366 * e) & nt) | (((3120437893 * ((e << 16) | (t >>> 16))) & nt) >>> 16);
    t ^= e >>> 1;
...
class AnnotationStorage {
  ...
  remove(t) {
    ...
    if ('function' == typeof this.onAnnotationEditor) {
      for (const t of this.#Ze.values()) if (t instanceof AnnotationEditor) return;
      this.onAnnotationEditor(null);
    }
  }
  setValue(t, e) {
...
class FontFaceObject {
  constructor(t, { disableFontFace: e = !1, fontExtraProperties: i = !1, inspectFont: s = null }) {
    ...
    const e = t.streamId,
      ...
      o = {
        enqueue(t, a = 1, r) {
          ...
          n.postMessage({ sourceName: i, targetName: s, stream: ut, streamId: e, chunk: t }, r);
        },
        close() {
          if (!this.isCancelled) {
            this.isCancelled = !0;
...
class MeshShadingPattern extends BaseShadingPattern {
  ...
  getPattern(t, e, i, s) {
    applyBoundingBox(t, this._bbox);
    let n;
    if (s === wt) n = Util.singularValueDecompose2dScale(getCurrentTransform(t));
    else {
    ...
    const a = this._createMeshCanvas(n, s === wt ? null : this._background, e.cachedCanvases);
    if (s !== wt) {
...
class CanvasGraphics {
  ...
  _createMaskCanvas(t) {
    ...
    w.imageSmoothingEnabled = getImageSmoothingEnabled(getCurrentTransform(w), t.interpolate);
    drawImageAtIntegerCoords(w, h, 0, 0, h.width, h.height, 0, 0, i, s);
    w.globalCompositeOperation = 'source-in';
    const x = Util.transform(getCurrentTransformInverse(w), [1, 0, 0, 1, -v, -y]);
  ...
  stroke(t = !0) {
    ...
    if (this.contentVisible)
      if ('object' == typeof i && i?.getPattern) {
        e.save();
        e.strokeStyle = i.getPattern(e, this, getCurrentTransformInverse(e), At);
  ...
  endText() {
    ...
    for (const { transform: e, x: n, y: a, fontSize: r, path: o } of t)
      i.addPath(o, new DOMMatrix(e).preMultiplySelf(s).translate(n, a).scale(r, -r));
    e.clip(i);
    e.beginPath();
  ...
  paintChar(t, e, i, s, n) {
    ...
    let g;
    (o.disableFontFace || c || u || p) && (g = o.getPathGenerator(this.commonObjs, t));
  ...
  showText(t) {
    ...
    if (e.patternFill) {
      n.save();
      const t = e.fillColor.getPattern(n, this, getCurrentTransformInverse(n), bt);
    ...
    if (e.patternStroke) {
      n.save();
      const t = e.strokeColor.getPattern(n, this, getCurrentTransformInverse(n), At);
  ...
  paintImageMaskXObjectGroup(t) {
    ...
    for (const n of t) {
      ...
      h.fillStyle = s ? i.getPattern(h, this, getCurrentTransformInverse(e), bt) : i;
      h.fillRect(0, 0, a, r);
      h.restore();
      e.save();
      e.transform(...o);
...
class OptionalContentGroup {
  ...
  get visible() {
    ...
    return this.#fi ? 'OFF' !== e?.viewState : !this.#bi || 'OFF' !== t?.printState;
  }
  _setVisible(t, e, i = !1) {
...
class OptionalContentConfig {
  ...
  constructor(t, e = r) {
    ...
    if (null !== t) {
      ...
      this.#_i = t.order;
      for (const i of t.groups) this.#yi.set(i.id, new OptionalContentGroup(e, i));
      if ('OFF' === t.baseState) for (const t of this.#yi.values()) t._setVisible(Tt, !1);
    ...
    if (s) {
      if (i && e && s.rbGroups.length)
        for (const e of s.rbGroups)
          for (const i of e) i !== t && this.#yi.get(i)?._setVisible(Tt, !1, !0);
    ...
    fetch(a, createFetchOptions(n, this._withCredentials, this._abortController))
      .then((e) => {
        ...
        if (i !== t._responseOrigin)
          throw new Error(`Expected range response-origin "${i}" to match "${t._responseOrigin}".`);
        if (!validateResponseStatus(e.status)) throw createResponseStatusError(e.status, a);
...
class PDFNodeStreamFsRangeReader {
  constructor(t, e, i) {
    ...
    this._setReadableStream(n.createReadStream(this._url, { start: e, end: i - 1 }));
  }
  get isStreamingSupported() {
    return this._isStreamingSupported;
  }
  ...
  It = e
    ...
    : class DOMFilterFactory extends BaseFilterFactory {
        ...
        addHighlightHCMFilter(t, e, i, s, n) {
          ...
          this.#ps(g);
          this.#cs(getSteps(c[0], u[0], 5), getSteps(c[1], u[1], 5), getSteps(c[2], u[2], 5), g);
          r.url = this.#hs(p);
          return r.url;
        }
        destroy(t = !1) {
...
function getDocument(t = {}) {
  ...
  const i = new PDFDocumentLoadingTask(),
    ...
    d = Number.isInteger(t.rangeChunkSize) && t.rangeChunkSize > 0 ? t.rangeChunkSize : Dt;
  ...
  const u = t.verbosity,
    ...
    w = !0 !== t.stopAtErrors,
    v = Number.isInteger(t.maxImageSize) && t.maxImageSize > -1 ? t.maxImageSize : -1,
...
class PDFWorker {
  ...
  constructor({ name: t = null, port: e = null, verbosity: i = getVerbosityLevel() } = {}) {
    ...
    if (e) {
      if (PDFWorker.#Ss?.has(e)) throw new Error('Cannot use more than one PDFWorker per port.');
...
class WorkerTransport {
    ...
    t.on('PasswordRequest', (t) => {
      ...
      try {
        ...
        const updatePassword = (t) => {
          t instanceof Error ? this.#Rs.reject(t) : this.#Rs.resolve({ password: t });
        };
  ...
  getOptionalContentConfig(t) {
    return this.#Is('GetOptionalContentConfig').then((e) => new OptionalContentConfig(e, t));
  }
  getPermissions() {
...
class PDFObjects {
  ...
  get(t, e = null) {
    ...
    const i = this.#Fs[t];
    if (!i || i.data === Lt) throw new Error(`Requesting object that isn't resolved yet ${t}.`);
    return i.data;
  }
  has(t) {
    const e = this.#Fs[t];
...
class PopupElement {
  ...
  render() {
    ...
    if (this.#in) {
      ...
      t.setAttribute('data-l10n-args', JSON.stringify({ dateObj: this.#in.valueOf() }));
      e.append(t);
    }
    const s = this.#un;
    if (s) {
  ...
  get #un() {
    const t = this.#hn,
      e = this.#en;
    return !t?.str || (e?.str && e.str !== t.str) ? null : this.#hn.html || null;
  }
  get #pn() {
...
class InkAnnotationElement extends AnnotationElement {
  ...
  updateEdited(t) {
    ...
    if (s) {
      const { transform: t, width: e, height: i } = this.#_n(this.data.rotation, s);
...
class FreeTextEditor extends AnnotationEditor {
  ...
  constructor(t) {
    ...
    this.#tn = t.color || FreeTextEditor._defaultColor || AnnotationEditor._defaultLineColor;
  ...
  serialize(t = !1) {
    ...
    const e = FreeTextEditor._internalPadding * this.parentScale,
      ...
      s = AnnotationEditor._colorManager.convert(
        this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#tn
      ),
      n = {
        annotationType: g.FREETEXT,
        color: s,
...
class FreeDrawOutliner {
  ...
  add({ x: t, y: e }) {
    ...
    if (Math.abs(Math.atan2(A - o, b - r) - Math.atan2(f, m)) < Math.PI / 2) {
      ...
      this.#Xn.push(NaN, NaN, NaN, NaN, ((r + l) / 2 - i) / n, ((o + h) / 2 - s) / a);
      [r, o, b, A] = this.#Kn.subarray(14, 18);
      this.#jn.push(NaN, NaN, NaN, NaN, ((b + r) / 2 - i) / n, ((A + o) / 2 - s) / a);
      return !0;
    }
  ...
  getOutlines() {
    ...
    this.#ua(l, h);
    return this.newFreeDrawOutline(l, o, this.#Vn, this.#ta, this.#Wn, this.#qn);
  }
  #da(t) {
    const e = this.#Kn,
      [i, s, n, a] = this.#Vn,
    ...
    return this.newFreeDrawOutline(d, t, this.#Vn, this.#ta, this.#Wn, this.#qn);
  }
  #ua(t, e) {
    const i = this.#jn;
...
class ColorPicker {
  ...
  constructor({ editor: t = null, uiManager: e = null }) {
    ...
    this.#Ta = t?.color || this.#m?.highlightColors.values().next().value || '#FFFF98';
  ...
  updateColor(t) {
    ...
    for (const i of this.#Ma.children) i.setAttribute('aria-selected', e.next().value === t);
  }
  destroy() {
    this.#Sa?.remove();
    this.#Sa = null;
...
class HighlightEditor extends AnnotationEditor {
  ...
  #er() {
    ...
    const e = new HighlightOutliner(this.#Ua, 0.0025, 0.001, 'ltr' === this._uiManager.direction);
  ...
  #Za({ highlightOutlines: t, highlightId: e, clipPathId: i }) {
    ...
    if (e >= 0) {
      ...
      this.parent.drawLayer.updateProperties(this.#w, {
        bbox: HighlightEditor.#ir(this.#qa.box, (e - this.rotation + 360) % 360),
        path: { d: t.toSVGPath() },
      });
  ...
  rotate(t) {
    ...
    } else i = HighlightEditor.#ir([this.x, this.y, this.width, this.height], t);
...
class DrawingEditor extends AnnotationEditor {
  ...
  _onResizing() {
    this.parent?.drawLayer.updateProperties(
      this._drawId,
      DrawingEditor._mergeSVGProperties(this.#gr.getPathResizingSVGProperties(this.#Cr()), {
        bbox: this.#Tr(),
      })
    );
  }
  _onResized() {
    this.parent?.drawLayer.updateProperties(
      this._drawId,
      DrawingEditor._mergeSVGProperties(this.#gr.getPathResizedSVGProperties(this.#Cr()), {
        bbox: this.#Tr(),
      })
    );
  }
  ...
  _onTranslated() {
    this.parent?.drawLayer.updateProperties(
      this._drawId,
      DrawingEditor._mergeSVGProperties(
        this.#gr.getPathTranslatedSVGProperties(this.#Cr(), this.parentDimensions),
        { bbox: this.#Tr() }
      )
    );
  }
  ...
  rotate() {
    this.parent &&
      this.parent.drawLayer.updateProperties(
        ...
        DrawingEditor._mergeSVGProperties(
          { bbox: this.#Tr() },
          this.#gr.updateRotation((this.parentRotation - this.rotation + 360) % 360)
        )
      );
  }
  onScaleChanging() {
    this.parent &&
      this.#Sr(this.#gr.updateParentDimensions(this.parentDimensions, this.parent.scale));
  }
  ...
  static startDrawing(t, e, i, s) {
    const { target: n, offsetX: a, offsetY: r, pointerId: o, pointerType: l } = s;
    ...
    if (DrawingEditor.#fr)
      t.drawLayer.updateProperties(this._currentDrawId, DrawingEditor.#fr.startNew(a, r, d, c, h));
    else {
    ...
    if (!DrawingEditor.#fr.isEmpty()) {
      const {
        ...
        a = e.createAndAddNewEditor({ offsetX: 0, offsetY: 0 }, !1, {
          ...
          drawOutlines: DrawingEditor.#fr.getOutlines(i * n, s * n, n, this._INNER_MARGIN),
...
class InkDrawOutliner {
  ...
  add(t, e) {
    ...
    return i || (2 === this.#ia.length ? { path: { d: this.toSVGPath() } } : null);
  }
  startNew(t, e, i, s, n) {
    this.#Rr = i;
    this.#Ir = s;
...
class InkDrawOutline extends Outline {
      ...
      if (6 !== e.length)
        if (12 !== e.length)
          for (let i = 6, s = e.length; i < s; i += 6) {
            const [s, n, a, r, o, l] = e.subarray(i, i + 6).map(Outline.svgRound);
  ...
  static deserialize(t, e, i, s, n, { paths: { lines: a, points: r }, rotation: o, thickness: l }) {
    ...
    if (!a) {
      ...
      for (const t of r) {
        ...
        if (4 === e) {
          a.push(
            new Float32Array([NaN, NaN, NaN, NaN, t[0], t[1], NaN, NaN, NaN, NaN, t[2], t[3]])
          );
          continue;
        }
  ...
  #Hr(t = this.#ea) {
    ...
    return this.#Fi % 180 == 0 ? [e / this.#Rr, e / this.#Ir] : [e / this.#Ir, e / this.#Rr];
  }
  #Br() {
  ...
  getPathResizingSVGProperties([t, e, i, s]) {
    const [n, a] = this.#Hr(),
      [r, o, l, h] = this.#pa;
    if (Math.abs(l - n) <= Outline.PRECISION || Math.abs(h - a) <= Outline.PRECISION) {
      const n = t + i / 2 - (r + l / 2),
        a = e + s / 2 - (o + h / 2);
      return {
        path: {
  ...
  getPathResizedSVGProperties([t, e, i, s]) {
    ...
    r[2] = i;
    r[3] = s;
    if (Math.abs(h - n) <= Outline.PRECISION || Math.abs(d - a) <= Outline.PRECISION) {
      const n = t + i / 2 - (o + h / 2),
        a = e + s / 2 - (l + d / 2);
      for (const { line: t, points: e } of this.#Pr) {
...
class InkEditor extends DrawingEditor {
  ...
  static createDrawerInstance(t, e, i, s, n) {
    return new InkDrawOutliner(t, e, i, s, n, this._defaultDrawingOptions['stroke-width']);
  }
  static deserializeDraw(t, e, i, s, n, a) {
...
class StampEditor extends AnnotationEditor {
  ...
  #so(t) {
    ...
    if (this.#Kr) {
      ...
      n.getContext('2d').drawImage(this.#Ur, 0, 0, this.#Ur.width, this.#Ur.height, 0, 0, i, s);
  ...
  serialize(t = !1, e = null) {
    ...
    if (null === e) return i;
    e.stamps ||= new Map();
    const a = this.#Kr ? (i.rect[2] - i.rect[0]) * (i.rect[3] - i.rect[1]) : null;
...
class AnnotationEditorLayer {
  ...
  disable() {
    ...
    for (const t of AnnotationEditorLayer.#U.values()) i.remove(`${t._type}Editing`);
    this.disableTextSelection();
    this.toggleAnnotationLayerPointerEvents(!0);
    this.#do = !1;
  }
  ...
  detach(t) {
    ...
    !this.#do && t.annotationElementId && this.#m.addDeletedAnnotationElement(t);
  }
  remove(t) {
    this.detach(t);
  ...
  moveEditorInDOM(t) {
    ...
    t._structTreeParentId = this.#Cn?.moveElementInDOM(this.div, t.div, t.contentDiv, !0);
  }
  addOrRebuild(t) {
  ...
  pointerup(t) {
    const { isMac: e } = util_FeatureTest.platform;
    if (!(0 !== t.button || (t.ctrlKey && e)) && t.target === this.div && this.#ho) {
      this.#ho = !1;
